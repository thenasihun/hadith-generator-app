  ...
  const fetchHadith = (params: {
    ...
    const fetchPromise = fetch(apiUrl)
      ...
      .then((data) => {
        ...
        return false; // API fetch failed or no data
      })
      .catch(() => false); // API fetch error
    ...
    Promise.race([fetchPromise, timeoutPromise]).then((success) => {
      if (!success) {
        // If API fetch failed or timed out, use simulated data
